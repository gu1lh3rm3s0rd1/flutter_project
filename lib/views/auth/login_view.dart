    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (ok) {
        ...
        DialogsHelper.showSnackBar(
          context,
          auth.errorMessage ?? 'Credenciais invalidas. Use um usuario cadastrado.',
        );
      }
    }
  }
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFFF4F6F8), Color(0xFFE8EEF4)],
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: auth.isLoading ? null : _tentarLogin,
                  ...
                  Container(
                    ...
                    child: Text(
                      AppEnvironment.useFirebase
                          ...
                          : 'Modo local ativo. A conta demo e\nmarina@autoflow.com / 123456',
                      textAlign: TextAlign.center,
                    ),
                  ),
